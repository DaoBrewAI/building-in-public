...
# Production reprovision was removed; retained rework uses task-outcome.py reopen.
"$ORC_TEST_LIFECYCLE_REAL" reprovision >/dev/null 2>&1
RETIRED_REPROVISION_RC=$?
check "retired reprovision mode cannot recreate a collected native child" test "$RETIRED_REPROVISION_RC" -ne 0

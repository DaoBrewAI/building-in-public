...
check "invocation authorizes least-scope planning and review" "$SKILL" 'Invoking Orchestrator authorizes `auto-least-scope` Fable/Opus planning and review'
check "auto mode uses a nonblocking notice" "$SKILL" 'Give this nonblocking notice once, then continue'
